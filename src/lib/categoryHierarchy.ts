...
export const SUBCATEGORY_PARENT: Record<string, string> = {
  ...
  'Краны, скобы, клапана': 'polipropilen',
  'Муфта комбинированная': 'polipropilen',
  'Тройники комбинированные с НР': 'polipropilen',
  'Муфты комбинированные с НР': 'polipropilen',
  'Муфты соединительные': 'polipropilen',
  'Муфты разъемные с НР': 'polipropilen',
  // Водонагреватели
